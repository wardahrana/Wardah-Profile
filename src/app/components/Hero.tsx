...
<div className='max-w-3xl mx-auto text-center'>
    ...
    transition={{delay:0.2}}
     className='flex flex-col items-center mb-4'>
        <Image src="/girly-laptop.jpg" alt="profile image"  width ={150} height={150} className='rounded-full mb-4 w-32 h-32 object-cover ring-2 ring-primary'/>
    </motion.div>
    <motion.h1 
    {...fadeInUp}
    transition={{delay:0.3}}
    className='text-4xl md:text-6xl font-bold mb-6'> {"Hi, I'm "}  <span className='text-primary'>Wardah Najam</span></motion.h1>
<motion.p 
{...fadeInUp}
